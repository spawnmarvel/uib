...
//	    		if (myShift.getDate().equalsIgnoreCase(searchString)){
//	    		    return myShift;
//	    		    }
//	    		}
//	    	FeedbackHandler.failedFeedback("Vakt finnes ikke");
//	    	return null;
//	    	}
/**
 ...
 */
	    ...
	    /**
	     * initiates the list of shifts 
	     * assigns the arrayList of shifts "atWork" to the actual list from database.
	     * @param innList
	     */
	    public void setList(ArrayList<Shift> innList){
	    	atWork = innList;
	    }
