...
public class Shift  {
	 ...
	 */
	public Shift(String date, String startTime, String endTime, int anEmployeeId,String name, String comment){
		this.date = date;
		this.startTime = startTime;
		this.endTime = endTime;
		this.anEmployeeId = anEmployeeId;
		this.name = name;
		setComment(comment);
	}
	/**
	...
	public String toString() {
		...
		"] [ Starttid: " + startTime + "]" +
		" [Sluttid: " + endTime + "]" +
		" [Navn: " + name + "] [IDNummer: " + anEmployeeId + "]" +
		" [Kommentar: " + comment + "]" + "\n" ;
		return returnString;
	}
